...
[지침]
1. 위 후보 중 「${topic}」와 가장 직접적으로 관련된 영화 3편을 골라주세요.
2. 등급이 [미상]인 영화도 ${age}세에게 부적절해 보이지 않으면 추천 가능 (당신의 영화 지식으로 판단).
3. 다만 19세 청소년관람불가가 명백하면 제외.
4. 후보 줄거리를 단서로 「${topic}」와 어떻게 연결되는지 구체적으로 적어주세요.
5. 반드시 후보 목록의 한국어 제목 표기를 그대로 사용.

반드시 아래 JSON 배열로만 응답하세요(정확히 3개, 후보가 3편 미만이면 가능한 만큼):
[
  {
    "title": "후보 목록의 영화제목",
    "year": "개봉연도",
